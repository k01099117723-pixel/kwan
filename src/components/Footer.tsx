...
export const Footer: React.FC<FooterProps> = ({ onOpenAdmin, onNavigate, customLogoUrl }) => {
  return (
    <footer className="bg-[#050609] border-t border-[#141824] pt-16 pb-12 text-[#8292a8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-[#141824]">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <p className="text-sm text-[#93a2b8] leading-relaxed max-w-sm">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a
                ...
                className="w-9 h-9 rounded-xl bg-[#0e121a] border border-[#1b2333] flex items-center justify-center text-[#8e9faf] hover:text-[#d4af37] hover:border-[#d4af37]/40 transition-colors"
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#top" className="hover:text-[#f3e5ab] transition-colors">Accueil</a>
              </li>
              <li>
                <a href="#studio" className="hover:text-[#f3e5ab] transition-colors">Le Studio</a>
              </li>
              <li>
                <a href="#packs" className="hover:text-[#f3e5ab] transition-colors">Nos 3 Formules</a>
              </li>
              <li>
                <a href="#equipements" className="hover:text-[#f3e5ab] transition-colors">Équipements Broadcast</a>
              </li>
              <li>
                <a href="#pourquoi-kwan" className="hover:text-[#f3e5ab] transition-colors">Pourquoi Kwan Studio</a>
              </li>
              <li>
                <button onClick={() => onNavigate('blog')} className="hover:text-[#f3e5ab] transition-colors text-left">
                  Blog & Conseils Podcast
                </button>
              </li>
              <li>
                <a href="#contact" className="hover:text-[#f3e5ab] transition-colors">Contact & Accès</a>
              </li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <p className="text-sm text-[#93a2b8] leading-relaxed">
