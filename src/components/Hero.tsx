...
import { ArrowRight, Sparkles, Video, Mic, Clock, Shield } from 'lucide-react';
...
export const Hero: React.FC<HeroProps> = ({
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    // Subtly bound the tilt angles to maintain broadcast elegance
    setTilt({ x: x * 6, y: -y * 6 });
  };
  ...
  return (
    <section id="top" className="relative min-h-[96vh] flex flex-col justify-center pt-28 pb-16 overflow-hidden studio-grid-pattern">
      {/* Background Ambient Lighting & High-End Studio Orbs with slow motion */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[850px] h-[550px] bg-gradient-to-tr from-[#d4af37]/15 via-[#f3e5ab]/8 to-transparent rounded-full blur-[160px] pointer-events-none animate-slow-orbit" />
      <div className="absolute top-2/3 right-10 w-[460px] h-[460px] bg-amber-600/10 rounded-full blur-[150px] pointer-events-none animate-slow-orbit-rev" />
      <div className="absolute bottom-10 left-10 w-[400px] h-[400px] bg-blue-900/15 rounded-full blur-[150px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full space-y-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          {/* Left Column: Headlines & CTAs with staggered reveals */}
          <div className="lg:col-span-7 text-center lg:text-left space-y-7">
            
            {/* Moroccan Identity & Broadcast Badge */}
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-[#111624]/90 backdrop-blur-md border border-[#d4af37]/35 shadow-lg shadow-[#d4af37]/10 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <p className="text-[#9ab0c8] text-base sm:text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0 font-normal animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150 fill-mode-both">
              {subtitle}
            </p>

            {/* Action Buttons with smooth staggered hover states */}
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-1 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-300 fill-mode-both">
              <button
                onClick={onOpenBooking}
                className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-[#d4af37] via-[#f3e5ab] to-[#d4af37] animate-gold-flow text-[#07080c] font-black text-sm sm:text-base shadow-xl shadow-[#d4af37]/25 hover:shadow-[#d4af37]/50 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3 group relative overflow-hidden"
              >
                {/* Button shine sweep */}
              ...
              <button
                ...
                className="w-full sm:w-auto px-7 py-4 rounded-2xl bg-[#111522]/90 hover:bg-[#181f30] text-white font-bold text-sm sm:text-base border border-[#232c42] hover:border-[#d4af37]/50 hover:shadow-lg hover:shadow-black/60 transition-all duration-300 flex items-center justify-center gap-2 active:scale-[0.98]"
              >
            ...
            {/* Trust Metrics Bar */}
            <div className="pt-6 grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-[#192233] animate-in fade-in slide-in-from-bottom-3 duration-700 delay-400 fill-mode-both">
              <div className="flex items-center gap-3 p-2 rounded-xl bg-[#0e121c]/40 border border-[#1a2233]/60 hover:border-[#d4af37]/30 transition-colors">
          ...
          {/* Right Column: 3D-inspired Cinematic Visual Composition with Parallax Tilt */}
          <div className="lg:col-span-5 relative perspective-1000">
            ...
            >
              ...
              {/* Outer Decorative Frame with Subtle Gold Border Glow & Light Sweep */}
              <div className="relative rounded-3xl overflow-hidden p-2 bg-gradient-to-b from-[#d4af37]/45 via-[#1e2638] to-[#0c0f17] shadow-2xl shadow-black/90 group gold-light-sweep">
                <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-[#0c0f16]">
                  <img
                    ...
                    className="w-full h-full object-cover transform scale-100 group-hover:scale-105 transition-all duration-700 filter brightness-95 group-hover:brightness-100 contrast-105"
                  />
                  ...
                  <div className="absolute top-4 left-4 flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-black/80 backdrop-blur-md border border-red-500/50 shadow-lg shadow-red-500/20">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between p-3.5 rounded-2xl bg-[#0b0f17]/90 backdrop-blur-md border border-[#222d42] shadow-xl">
              ...
              <div className="hidden sm:flex absolute -top-4 -right-4 items-center gap-2 px-3.5 py-2 rounded-xl bg-[#141926]/95 backdrop-blur-md border border-[#27324a] shadow-xl shadow-black/60 group-hover:border-[#d4af37]/50 transition-colors">
